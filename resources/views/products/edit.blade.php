                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" class="form-control" placeholder="Title" name="title" value="{{ $product->title }}">
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="supplier_id" id="supplier">
                                                    @foreach ($suppliers as $supplier)
                                                        @php
                                                            $supplier_check = $product->supplier_id == $supplier->id ? 'selected' : '';
                                                        @endphp
                                                        <option {{ $supplier_check }} value="{{ $supplier->id }}">{{ $supplier->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="model" class="form-control" name="model" placeholder="Model" value="{{ $product->model }}">
                                                    @if ($errors->has('model'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="category_id" id="category">
                                                    ...
                                                    @foreach ($categories as $cat)
                                                        @php $check = $cat->id == $product->category_id ? 'selected' : '' @endphp
                                                        <option class="form-control" {{ $check }} value="{{ $cat->id }}">{{ $cat->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
